...
function getClient($authCode = '')
{
    ...
    //TODO: paste correct google app credentials
    ...
    if ($client->isAccessTokenExpired()) {
        ...
        if ($client->getRefreshToken()) {
            ...
            echo ("Open the following link in your browser: <a href='" . $authUrl . "' > click </a>");
            echo '<br>Enter verification code as GET parameter ?code=';
